//Create a topology with 10 nodes which forms a mesh topology and communicates using UDP.
...
int main(int argc, char *argv[]){
  ...
  pointToPoint.EnableAsciiAll(ascii.CreateFileStream("Lab5Q2.tr"));
  AnimationInterface anim("Lab5Q2.xml");
  Simulator::Run ();
  Simulator::Destroy ();
  return 0;
}
