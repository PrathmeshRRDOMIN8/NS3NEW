//For  the  topologies  given  in  lab  2,  generate  the  pcap  file  and  analyze  the  same  using Wireshark.  Calculate  throughput,  delay  and  packet  delivery  ratio  and  plot  suitable  graphs using GNUPLOT.
...
main (int argc, char *argv[])
{
  ...
  BulkSendHelper source ("ns3::TcpSocketFactory", InetSocketAddress (interfaces2.GetAddress (4), port));
  ...
  if (tracing)
    {
      ...
      pointToPoint.EnableAsciiAll (ascii.CreateFileStream ("Lab3Q1.tr"));
