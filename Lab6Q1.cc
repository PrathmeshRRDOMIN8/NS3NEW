// 1.Implement RIPng for the below given scenario.SRC|<=== source networkA-----B\/ \|all networks have cost 1, except\/  |   |for the direct link from C to D, whichC  /    |has cost 10| /||/       |D ------E|<=== target networkDST
...
int main (int argc, char **argv)
{
  ...
  csma.EnableAsciiAll (ascii.CreateFileStream ("Lab6Q1.tr"));
  std::string animFile = "Lab6Q1.xml";
